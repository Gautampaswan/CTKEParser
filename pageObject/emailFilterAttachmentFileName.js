...
class emailFilter {
    ...
    constructor(page) {
        ...
        this.sourceOptionName = 'Attachment File Names'; //Need to change as per requirement
    ...
    async newEmailFilter(email_Filter_Name, filter_Value, email_Sequence) {
        ...
        await expect(this.emailFilterNameValidation).toHaveText("Attachment File Name Verification");
