...
class emailFilter {
    ...
    constructor(page) {
        ...
        this.sourceOptionName = 'From Name'; //Need to change as per requirement
...
//-------------------ASSERTIONS--------------------------//
        ...
        await expect(this.emailFilterNameValidation).toHaveText("Name_Verification");
        ...
        await this.page.waitForTimeout(3000);
        await expect(this.valueValidation).toHaveText("Kumar");
