...
class fieldParser {
    ...
    constructor(page) {
        ...
        this.sourceName = 'Subject'; //Need to Change as per requirement
        ...
        this.rangestartName = 'Text Delimiter'; //Need to Change as per requirement
        ...
        this.rangeEndName = 'End of Line';//Need to Change as per requirement
    ...
    async newBuildFieldParser(range_StartValue, range_EndValue) 
        ...
        //To Validate the Field Parser Reference Name.
        await this.page.waitForTimeout(3000);
        await expect(this.sourceTypeValidation).toHaveText("Subject");
