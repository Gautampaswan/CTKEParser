...
class fieldParser {
    ...
    constructor(page) {
        ...
        this.sourceName = 'Header'; //Need to Change as per requirement
        ...
        this.headerNameValidation = page.locator('[data-field-id="Recordctkemailparser_HeaderName_cField"] span.test-id__field-value').last();
        ...
        //this.textContent = page.locator("[data-field='testContent'] .slds-textarea");

        this.RangeStart = page.locator("[role='combobox']");

        this.Rangestartoption = page.locator("[role='option']");

        this.rangestartName = 'Position'; //Need to Change as per requirement

        this.startPositionLine = page.locator('[name="ctkemailparser__StartPositionLine__c"]');

        this.startPositionCharacter = page.locator('[name="ctkemailparser__StartPositionCharacterNo__c"]');
    ...
    async newFieldParser(reference_Name, header_Name) {
        ...
        //Enter the Header Name in text box.
        await this.headerName.fill(header_Name);
    ...
    async newBuildFieldParser(start_Position, start_Position_Character, range_StartValue, range_EndValue) 
        {
...
//-------------------------------------ASSERTIONS-------------------------------------//
        ...
        //To Validate the Field Parser Reference Name.
        await this.page.waitForTimeout(3000);
        await expect(this.sourceTypeValidation).toHaveText("Header");
        
        //To Validate the Header Name
        await this.page.waitForTimeout(3000);
...
/* Use form Start Range to End Range when checked the scenario for range basd.
        ...
        //Enter the start position value
        await this.page.waitForTimeout(3000);
        await this.startPositionLine.fill(start_Position);

        //Enter the Start Position Character
        await this.page.waitForTimeout(3000);
        await this.startPositionCharacter.fill(start_Position_Character);
