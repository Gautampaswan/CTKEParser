...
class emailFilter {
    ...
    constructor(page) 
        ...
        this.sourceOptionName = 'From'; //Need to change as per requirement
    ...
    async newEmailFilter(email_Filter_Name, filter_Value, email_Sequence) {
        ...
        await expect(this.emailFilterNameValidation).toHaveText("Domain_Verification");
        ...
        await this.page.waitForTimeout(3000);
        await expect(this.valueValidation).toHaveText("cynoteck.com");
