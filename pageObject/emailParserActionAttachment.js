...
class emailParserActions {
  ...
  constructor(page) {
    ...
    this.actionTypeOptionName = "Create Record"; // Can be changed dynamically 'Create Record' or 'Attach To Record'
    ...
    this.fieldMappingName = "Last Name (LastName)"; // Example field to map

    //---------------------SELECT SOURCE DROPDOWN VALUE----------------------//

    this.fieldMappingName2 = "lastName"; // Example source field

    this.sourceDropdown = page.locator(".slds-combobox__input-value").nth(1);
