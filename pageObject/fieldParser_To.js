...
class fieldParser {
    ...
    constructor(page) {
        ...
        this.actionTypeOtionName = 'Text'; //Need to Change as per requirement
        ...
        this.sourceName = 'To'; //Need to Change as per requirement
        ...
        this.startPosition = page.locator('[name="ctkemailparser__StartPositionLine__c"]');

        this.startPositionCharacterNo = page.locator('[name="ctkemailparser__StartPositionCharacterNo__c"]');
        ...
        this.rangeEndName = 'Text Delimiter';//Need to Change as per requirement
    ...
    async newBuildFieldParser(start_Position, start_PositionCharacterNo, range_EndValue) 
        {
        ...
        await expect(this.referenceNameValidation).toHaveText("email");
        
        //To Validate the Field Parser Reference Name.
        await this.page.waitForTimeout(3000);
        await expect(this.sourceTypeValidation).toHaveText("To");
        ...
        await this.startPosition.fill(start_Position);

        //Enter the Range Start Value
        await this.page.waitForTimeout(2000);
        await this.startPositionCharacterNo.fill(start_PositionCharacterNo);
