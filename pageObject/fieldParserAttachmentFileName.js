...
class fieldParser {
    ...
    constructor(page) {
        ...
        this.sourceName = 'Attached File Names'; //Need to Change as per requirement
         
        this.MultipleResultHandler = page.locator("[role='combobox']").nth(4);

        this.MultipleResultHandleroption = page.locator("[role='option']");

        this.MultipleResultHandlerName = 'Last'; //Need to Change as per requirement
    ...
    async newBuildFieldParser()
        ...
        await expect(this.referenceNameValidation).toHaveText("Attchment_file_name");
        
        //To Validate the Field Parser Reference Name.
        await this.page.waitForTimeout(3000);
        await expect(this.sourceTypeValidation).toHaveText("Attached File Names");
