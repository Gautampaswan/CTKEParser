...
const { loginPage } = require('../pageObject/loginPage_Subject');
const { emailParser } = require('../pageObject/emailParser_Subject');
const { emailFilter } = require('../pageObject/emailFilter_Subject');
const { fieldParser } = require('../pageObject/fieldParser_Subject');
const { emailParserActions } = require('../pageObject/emailParserActions_Subject');

test('Test the functionality related to Subject Filter ', async ({ page }) => {
    ...
    await field_Parser.newBuildFieldParser(range_StartValue); 
